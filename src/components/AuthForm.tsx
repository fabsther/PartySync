      ...
      <div className="max-w-md w-full space-y-8">
        ...
        {!isForgotPassword && (
          <div className="text-center space-y-2 pt-2">
            <p className="text-neutral-300 text-sm">{t('description')}</p>
        ...
        {hasInvite && !isForgotPassword && (
          <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-4 flex items-start gap-3">
            ...
            <div>
              <p className="text-orange-300 font-medium text-sm">{t('invite_banner_title')}</p>
              <p className="text-neutral-400 text-xs mt-1">
                {isSignUp ? t('invite_banner_signup') : t('invite_banner_login')}
              </p>
            </div>
          </div>
        )}
        ...
        {!isForgotPassword && (
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-neutral-500 text-xs">{t('or')}</span>
              <div className="flex-1 h-px bg-neutral-800" />
            </div>
          </div>
        )}
